...
if(pcl_demos_CONFIG_INCLUDED)
  return()
endif()
set(pcl_demos_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(pcl_demos_SOURCE_PREFIX /home/robert/ROS/src/depth/pcl_demos)
  set(pcl_demos_DEVEL_PREFIX /home/robert/ROS/devel)
  set(pcl_demos_INSTALL_PREFIX "")
  set(pcl_demos_PREFIX ${pcl_demos_DEVEL_PREFIX})
else()
  set(pcl_demos_SOURCE_PREFIX "")
  set(pcl_demos_DEVEL_PREFIX "")
  set(pcl_demos_INSTALL_PREFIX /home/robert/ROS/install)
  set(pcl_demos_PREFIX ${pcl_demos_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'pcl_demos' is deprecated")
...
set(pcl_demos_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8 " STREQUAL " ")
  set(pcl_demos_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/vtk-5.8")
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${pcl_demos_DIR}/../../../include" ABSOLUTE)
      ...
      message(FATAL_ERROR "Project 'pcl_demos' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robert/ROS/src/depth/pcl_demos/${idir}'.  Ask the maintainer 'Luka Cehovin <luka.cehovin@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND pcl_demos_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(pcl_demos_LIBRARY_DIRS ${lib_path})
      list(APPEND pcl_demos_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'pcl_demos'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND pcl_demos_LIBRARIES ${lib})
    endif()
  endif()
...
set(pcl_demos_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${pcl_demos_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 pcl_demos_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${pcl_demos_dep}_FOUND)
      find_package(${pcl_demos_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pcl_demos_dep} REQUIRED ${depend_list})
  endif()
  _list_append_unique(pcl_demos_INCLUDE_DIRS ${${pcl_demos_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(pcl_demos_LIBRARIES ${pcl_demos_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${pcl_demos_dep}_LIBRARIES})
  _list_append_deduplicate(pcl_demos_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(pcl_demos_LIBRARIES ${pcl_demos_LIBRARIES})

  _list_append_unique(pcl_demos_LIBRARY_DIRS ${${pcl_demos_dep}_LIBRARY_DIRS})
  list(APPEND pcl_demos_EXPORTED_TARGETS ${${pcl_demos_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${pcl_demos_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
